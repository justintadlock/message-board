...
<form id="mb-form-search" method="get" action="<?php mb_board_home_url(); ?>">
	...
	<fieldset>
		...
		<p>
			...
			<br />
			<label>
				<input type="checkbox" name="post_type[]" value="<?php mb_topic_post_type(); ?>" /> 
				<?php _e( 'Topics', 'message-board' ); ?>
			</label>
			<br />
			<label>
				<input type="checkbox" name="post_type[]" value="<?php mb_reply_post_type(); ?>" /> 
